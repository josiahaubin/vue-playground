    ...
    <div class="row">
      <div class="col-12">
        <div class="border p-1">
          ...
          <p>
            Use the property "message" on the data object in our component for one way data binding
        ...
        <div class="border p-1">
          ...
          <p>
            Use a v-model to bind an input value from our html to a property in the components data object.
        ...
        <div class="border p-1">
          <h5>Class Binding</h5>
          <p>
            Use class binding to reference a property(isActive) in the components data object to determine
            when to add the class to the elements class list. Then change the value of that data
            property(isActive) to true. Notice Vue will rerender each time the value changes.
          </p>
          <div class="red">
...
export default {
  ...
  data() {
    return {
      ...
      message: "This is Josiah's not so super secret message!",
