    ...
    <div class="row">
      <div class="col-12">
        <div class="border p-1">
          ...
          <p>
            Use the v-for directive to loop over the "players" property on the components data. In the
            curlies inside of the template for each player we want to access each property on the player
            object to put the value into our html.
          </p>
        ...
        <div class="border p-1">
          ...
          <p>
            Use the v-for directive to loop over the "blog" property on the comments data. In the curlies
            inside of the template for each property on the object we want to print the key(property name)
            and value contained at that key.
          </p>
